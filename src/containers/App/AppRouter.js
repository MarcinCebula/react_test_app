        ...
        {/*
         ...
         <Route
           ...
           <Route
            exact
            path={`${url}/forms`}
            component={asyncComponent(() => import('../FormBuilderForms/antTables'))}
           >
         </Route>
         ...
         <Route
            exact
            path={`${url}/inquiries`}
            component={asyncComponent(() => import('../FormBuilderInquiries/antTables'))}
           >
         </Route>
         ...
         <Route
            ...
            component={asyncComponent(() => import('../FormBuilder'))}
           >
         </Route>
